...
Gem::Specification.new do |gem|
  ...
  gem.add_runtime_dependency 'jwt', '>= 1.5.6', '< 3.0'
  gem.add_runtime_dependency 'oauth2', '>= 1.4.2', '< 2.0'
  gem.add_runtime_dependency 'omniauth', '>= 1.9', '< 2.0'
  gem.add_runtime_dependency 'omniauth-oauth2', '>= 1.6', '< 2.0'
